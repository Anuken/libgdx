...
public abstract class ByteBuffer extends Buffer implements Comparable<ByteBuffer>, StringToByteBuffer{
     ...
     * @return the created byte buffer.
     * @throws IndexOutOfBoundsException if either {@code start} or {@code len} is invalid.
     * @since Android 1.0
     */
     ...
     * @throws ReadOnlyBufferException if this buffer is based on a read-only array.
     * @throws UnsupportedOperationException if this buffer is not based on an array.
     * @since Android 1.0
     */
     ...
     * @throws ClassCastException if {@code other} is not a byte buffer.
     * @since Android 1.0
     */
     ...
     * @throws BufferUnderflowException if the position is equal or greater than limit.
     * @since Android 1.0
     */
     ...
     * @return this buffer.
     * @throws BufferUnderflowException if {@code dest.length} is greater than {@code remaining()}.
     * @since Android 1.0
     */
     ...
     * @return this buffer.
     * @throws IndexOutOfBoundsException if either {@code off} or {@code len} is invalid.
     * @throws BufferUnderflowException if {@code len} is greater than {@code remaining()}.
     * @since Android 1.0
     */
     ...
     * @throws BufferUnderflowException if the position is greater than {@code limit - 2}.
     * @since Android 1.0
     */
     ...
     * @throws BufferUnderflowException if the position is greater than {@code limit - 8}.
     * @since Android 1.0
     */
     ...
     * @throws BufferUnderflowException if the position is greater than {@code limit - 4}.
     * @since Android 1.0
     */
     ...
     * @return this buffer.
     * @throws BufferOverflowException if position is equal or greater than limit.
     * @throws ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0
     */
     ...
     * @return this buffer.
     * @throws BufferOverflowException if {@code remaining()} is less than {@code src.length}.
     * @throws ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0
     */
     ...
     * @return this buffer.
     * @throws BufferOverflowException if {@code remaining()} is less than {@code len}.
     * @throws IndexOutOfBoundsException if either {@code off} or {@code len} is invalid.
     * @throws ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0
     */
     ...
     * @return this buffer.
     * @throws BufferOverflowException if {@code src.remaining()} is greater than this buffer's {@code remaining()}.
     ...
     * @return this buffer.
     * @throws BufferOverflowException if position is greater than {@code limit - 2}.
     * @throws ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0
     */
     ...
     * @return this buffer.
     * @throws BufferOverflowException if position is greater than {@code limit - 8}.
     * @throws ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0
     */
     ...
     * @return this buffer.
     * @throws BufferOverflowException if position is greater than {@code limit - 4}.
     * @throws ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0
     */
