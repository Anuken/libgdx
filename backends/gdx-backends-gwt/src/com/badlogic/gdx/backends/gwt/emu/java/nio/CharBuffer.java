...
public abstract class CharBuffer extends Buffer implements Comparable<CharBuffer>, CharSequence, Appendable{// , Readable {
     ...
     * @return the created char buffer.
     * @throws IndexOutOfBoundsException if either {@code start} or {@code end} is invalid.
     * @since Android 1.0
     */
     ...
     * @throws ReadOnlyBufferException if this buffer is based on an array, but it is read-only.
     ...
     * @throws ClassCastException if {@code otherBuffer} is not a char buffer.
     * @since Android 1.0
     */
     ...
     * @return this buffer.
     * @throws BufferOverflowException if {@code remaining()} is less than the length of string.
     * @throws ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0
     */
     ...
     * @return this buffer.
     * @throws BufferOverflowException if {@code remaining()} is less than {@code end - start}.
     * @throws IndexOutOfBoundsException if either {@code start} or {@code end} is invalid.
     * @throws ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0
     */
     ...
     * @return this buffer.
     * @throws BufferOverflowException if {@code remaining()} is less than the length of csq.
     * @throws ReadOnlyBufferException if no changes may be made to the contents of this buffer.
     * @since Android 1.0
     */
