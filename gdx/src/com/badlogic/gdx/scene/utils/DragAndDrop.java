...
public class DragAndDrop{
    ...
    public void addSource(final Source source){
        com.badlogic.gdx.scene.event.DragListener listener = new com.badlogic.gdx.scene.event.DragListener(){
    ...
    public void removeSource(Source source){
        com.badlogic.gdx.scene.event.DragListener dragListener = sourceListeners.remove(source);
