...
import io.anuke.arc.utils.reflect.*;
import io.anuke.arc.utils.serialization.JsonValue.PrettyPrintSettings;
import io.anuke.arc.utils.serialization.JsonWriter.OutputType;
        ...
        try{
            ...
            if(value instanceof io.anuke.arc.collection.Queue){
                if(knownType != null && actualType != knownType && actualType != io.anuke.arc.collection.Queue.class)
                    ...
                    + "Known type: " + knownType + "\nActual type: " + actualType);
                writeArrayStart();
                io.anuke.arc.collection.Queue queue = (io.anuke.arc.collection.Queue)value;
